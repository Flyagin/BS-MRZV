...
//~~~     Перечень команд и их положение в массиве 0 до AMOUNT_BYTE_FOR_OEPRF
//~~~    описанного в enum ENMEpr_f_Out  файла  epr_f.h
//~~~    
...
//~~~     Перечень команд и их положение в массиве 0 до AMOUNT_BYTE_FOR_OEPRF
//~~~    описанного в enum ENMEpr_f_Out  файла  epr_f.h
//~~~    см также \hv_df.h строка 239 ->
//~~~   unsigned char uc_ar_do_rank_cfg[NUM_OUT*AMOUNT_BYTE_FOR_OEPRF]
