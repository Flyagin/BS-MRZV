...
void modbus_variables_init() {
  ...
  pDevIdentification.SoftwareVersion = 0x2020;
  pDevIdentification.DateOfCompilation1 = 0x2020;
  pDevIdentification.DateOfCompilation2 = 0x2020;
  pDevIdentification.TimeOfCompilation = 0x2020;
  pDevIdentification.VersionOfMemoryMap = 0x2020;
}
